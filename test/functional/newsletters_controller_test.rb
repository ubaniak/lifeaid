...
class NewslettersControllerTest < ActionController::TestCase
  ...
  test "should create newsletter" do
    assert_difference('Newsletter.count') do
      post :create, newsletter: { content: @newsletter.content, title: @newsletter.title, user_id: @newsletter.user_id }
    end
  ...
  test "should update newsletter" do
    put :update, id: @newsletter, newsletter: { content: @newsletter.content, title: @newsletter.title, user_id: @newsletter.user_id }
    assert_redirected_to newsletter_path(assigns(:newsletter))
  end
